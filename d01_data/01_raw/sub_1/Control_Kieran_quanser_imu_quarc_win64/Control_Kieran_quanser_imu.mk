...
MODEL                = Control_Kieran_quanser_imu
MODULES              = Control_Kieran_quanser_imu_data.c Control_Kieran_quanser_imu_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = Control_Kieran_quanser_imu.mk
...
MODELLIB                  = Control_Kieran_quanser_imulib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Control_Kieran_quanser_imu_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\QUANSE~1\Desktop\HRIMUL~1\exosuit\YANGSI~1\data\subject1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Control_Kieran_quanser_imu_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\QUANSE~1\Desktop\HRIMUL~1\exosuit\YANGSI~1
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\PROGRA~1\Quanser\QUARC\blocks\general

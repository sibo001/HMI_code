...
#define rtmGetStepSize(rtm)            (0.006)
#endif
...
typedef RT_MODEL_Control_Kieran_quans_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Control_Kieran_quanser_imu(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Control_Kieran_quanser_imu_initialize();
   extern void Control_Kieran_quanser_imu_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Control_Kieran_quanser_imu_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  Control_Kieran_quanser_imu_step();
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Control_Kieran_quanser_imu:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Control_Kieran_quanser_imu -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Control_Kieran_quanser_imu_initialize();
  S = Control_Kieran_quanser_imu_M;
  ...
  Control_Kieran_quanser_imu_terminate();
